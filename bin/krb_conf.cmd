...
IF EXIST "C:\Program Files\Git\mingw64\bin\create-shortcut.exe" (
	...
	ECHO|SET /p="!SHORTCUT! "
	create-shortcut.exe --work-dir "!SQLDEV_HOME!" --icon-file "!SQLDEV_HOME!\sqldeveloper.exe" --description "Kerberos kinit for SQL Developer created by !PROG!" "!SQLDEV_HOME!\krb_sqldeveloper.cmd" "%USERPROFILE%\Desktop\!SHORTCUT!.lnk"

	ECHO|SET /p="!SHORTCUTSQL! "
	create-shortcut.exe --work-dir "!SQLDEV_HOME!" --icon-file "!SQLDEV_HOME!\sqldeveloper\bin\sql.exe" --description "Kerberos kinit for SQLcl created by !PROG!" "!SQLDEV_HOME!\krb_sqlcl.cmd" "%USERPROFILE%\Desktop\!SHORTCUTSQL!.lnk"
...
:createkrb5conf
	...
	ECHO # Generated by !PROG!> !KRB5_CONFIG!
