...
A default `krb5.conf` file is generated by the tool unless you install your own template with the *-t* option:


<p align="center" spacing="10">
    <kbd>
        <img src="media/krb_conf_template.PNG" />
    </kbd>
</p>

This file will be used on subsequent invocations.

Two Desktop softcuts will be intalled.
